...
import javafx.builders.RotateBuilder;
import javafx.builders.TimelineBuilder;
import javafx.builders.TranslateBuilder;
	...
	public CubeNode(CubeModel model) {
		...
		setOnMousePressed(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent me) {
				...
				dragStartOffsetX =
						me.getScreenX() - getScene().getWindow().getX();
				dragStartOffsetY =
						me.getScreenY() - getScene().getWindow().getY();
			}
		});
			...
			public void handle(MouseEvent me) {
				if (me.isControlDown()) {
					...
					double proposedTranslateZ =
							curTranslateZ + ((me.getScreenY() - getScene()
									.getWindow().getY()) - dragStartOffsetY) *
									10;
	...
	public void goHomePosition() {
		Timeline homeTimeline = TimelineBuilder.create()
				.keyFrames(
						new KeyFrame(
								new Duration(1000.0),
								new KeyValue(angleX, HOME_ANGLE_X,
